...
const NavBar: React.FC<NavBarProps> = ({ darkMode, setDarkMode }) => {
    ...
    return (
    <nav className="bg-gray-200  shadow-lg dark:bg-gray-800 text-gray-950 dark:text-gray-100 fixed top-0 left-0 w-full z-50 ">
                ...
                <div className="hidden sm:ml-6 sm:block">
                    <div className="flex space-x-4 ">
                        ...
                        <input
                            ...
                            <div className="relative w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-gray-200 dark:peer-focus:ring-gray-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-gray-800 dark:after:bg-gray-300 after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-skyBlue">
                            </div>
                        </label>
                    </div>
                </div>
